...
class CSVDataBase(DataBase):
    ...
    def _get_csv_from_url(url,outfile):
        """
    ...
    def _get_wb_data(file_path,data_name):
    ...
    def _get_csse_time_series_deaths():
    ...
    def _get_apple_movement_indices(movement_type='walking'):
        """
